...
https://{url-to-my-interactive-app}/?id=<my_unique_interview_id>&tense=past&extra_instructions=off&num_suggestions=10
``` 
...
This can be done adding a query parameter named `id` to the URL, i.e., `https://{url-to-my-interactive-app}/?id=my_unique_interview_id` (with {url-to-my-interactive-app} corresponding to the URL your application is running at and my_unique_interview_id corresponding to the unique id).
